 ...
 * RSR-STU-001 — Named export `StudioHero`, consumed by app/studio/[slug]
 * and app/campaign/[slug].
 */

import ShareButtons from "@/components/shareButtons";
import type { Studio } from "@/services/studioService";
...
export function StudioHero({ studio }: StudioHeroProps) {
  ...
  return (
    <div className="relative w-full aspect-[21/9] bg-[var(--color-gray-100)] bg-cover bg-center flex items-end"
    ...
    >
      <div className="w-full bg-gradient-to-t from-[var(--color-black-950)]/80 to-transparent p-[var(--space-5)]">
        ...
        <p className="mt-[var(--space-1)] text-[var(--text-body)] text-[var(--color-gray-300)]">{studio.description}</p>
